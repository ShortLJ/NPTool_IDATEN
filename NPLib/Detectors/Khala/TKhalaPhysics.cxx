 ...
 *---------------------------------------------------------------------------*
 * Comment:                                                                  *
 *    Last update: Merging of Khala and TKhalaPhyscis class                  *
 *                                                                           *
 *****************************************************************************/
...
ClassImp(TKhalaPhysics)

  ////////////////////////////////////////////////////////////////////////////////
  TKhalaPhysics::TKhalaPhysics(){
    m_NumberOfModule = 0;
    m_EventData    = new TKhalaData();
    m_EventPhysics =this; 
  }
...
////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::BuildSimplePhysicalEvent(){
  BuildPhysicalEvent();
}

////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::BuildPhysicalEvent(){

  int multLaBrE = m_EventData->GetKhalaLaBr3EMult();

  KhalaEventMult=multLaBrE;
  ...
  if(KhalaEventMult>=1){
    ...
    for(int j=0;j<multLaBrE;j++){
      EnergyStripFront= m_EventData->GetKhalaLaBr3EEnergy(j);

      EnergyStrip  = EnergyStripFront;
      KhalaLaBr_E.push_back(EnergyStrip);
    ...
    KhalaInTotalEnergy.push_back(EnergyTot);
  }
}

////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::Clear(){
  //EventMultiplicity= 0;
  KhalaEventMult= 0;
  //ModuleNumber.clear();
  //EventType.clear();
  KhalaInTotalEnergy.clear();   // inner shell
  KhalaOutTotalEnergy.clear();  // outter shell
  KhalaTotalEnergy.clear();
...
////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::ReadConfiguration(NPL::InputParser parser){
  ...
  for(unsigned int i  = 0 ; i < blocks.size() ; i++){
    ...
    if(blocks[i]->HasTokenList(cart)){
      ...
      cout << "ERROR: Missing token for KhalaCluser blocks, check your input file" << endl;
      exit(1);
    }
...
////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::ReadCalibrationFile(string Path){
...
////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::InitializeRootInputRaw(){
  TChain* inputChain = RootInput::getInstance()->GetChain();
  inputChain->SetBranchStatus("Khala", true);
  inputChain->SetBranchStatus("fFATIMA*", true);
  inputChain->SetBranchAddress("Khala", &m_EventData);
}


////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::InitializeRootOutput(){
  TTree* outputTree = RootOutput::getInstance()->GetTree();
  outputTree->Branch("Khala", "TKhalaPhysics", &m_EventPhysics);
}
void TKhalaPhysics::AddDetector(TVector3 A,
    TVector3 B,
    TVector3 C,
    TVector3 D)
{
...
////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::AddDetector(double theta,
    double phi,
    double R,
    double beta_u,
    double beta_v,
...
////////////////////////////////////////////////////////////////////////////////
double TKhalaPhysics::GetEnergyDeposit(){
  if (m_EventPhysics->KhalaTotalEnergy.size() > 0)
    return m_EventPhysics->KhalaTotalEnergy[0];
  else
    return -1000;
}

////////////////////////////////////////////////////////////////////////////////
double TKhalaPhysics::GetEnergyInDeposit(){// inner Layer
  if (m_EventPhysics->KhalaInTotalEnergy.size() > 0)
    return m_EventPhysics->KhalaInTotalEnergy[0];
  else
    return -1000;
}

////////////////////////////////////////////////////////////////////////////////
double TKhalaPhysics::GetEnergyOutDeposit(){// Outer Layer
  if (m_EventPhysics->KhalaOutTotalEnergy.size() > 0)
    return m_EventPhysics->KhalaOutTotalEnergy[0];
  else
    return -1000;
}

////////////////////////////////////////////////////////////////////////////////
TVector3 TKhalaPhysics::GetPositionOfInteraction(){
  TVector3 Position = TVector3(-1000,-1000,-1000);
  return(Position);
}

////////////////////////////////////////////////////////////////////////////////
void TKhalaPhysics::Print(){
...
////////////////////////////////////////////////////////////////////////////////
NPL::VDetector* TKhalaPhysics::Construct(){
  return (NPL::VDetector*) new TKhalaPhysics();
}
...
class proxy_khala{
  public:
    proxy_khala(){
      NPL::DetectorFactory::getInstance()->AddToken("Khala","Khala");
      NPL::DetectorFactory::getInstance()->AddDetector("Khala",TKhalaPhysics::Construct);
    }
};
