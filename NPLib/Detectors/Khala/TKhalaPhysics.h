#ifndef TKHALAPHYSICS_H
#define TKHALAPHYSICS_H
/*****************************************************************************
...
class TKhalaPhysics : public TObject, public NPL::VDetector{
  public:
    TKhalaPhysics();
    ~TKhalaPhysics();
  ...
  public:
    ...
    TKhalaData*    GetEventData()      {return m_EventData;}//!
    TKhalaPhysics*   GetEventPhysics()   {return m_EventPhysics;}//!
  ...
  private:
    ...
    ////////////////////////////////////////
    TKhalaData*      m_EventData;//!
    TKhalaPhysics*   m_EventPhysics;//!
  ...
  public: // Data Member
    ...
    Int_t      KhalaEventMult;

    //   FirstStage
    vector<double>   KhalaLaBr_E;

    //   SecondStage
    vector<double>   KhalaNaI_E;

    // Physical Value  
    vector<double>   KhalaTotalEnergy;
    vector<double>   KhalaInTotalEnergy;
    vector<double>   KhalaOutTotalEnergy;

    public: // Static constructor to be passed to the Detector Factory
     static NPL::VDetector* Construct();
     ClassDef(TKhalaPhysics,1)
};
